<div class="w-full">
    <div class="mb-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-2xl font-bold">{{ __('New Project') }}</h2>
                <p class="text-base-content/70 mt-0.5 text-sm">{{ __('Group related monitors — e.g. a site and its APIs') }}</p>
            </div>
        </div>
    </div>
    ...
    <form wire:submit="save" class="max-w-2xl mx-auto">
            ...
            <div class="card-body gap-5">
                ...
                <div class="form-control">
                    ...
                    <textarea wire:model="description" rows="3"
                        ...
                        placeholder="{{ __('What is this project about?') }}"></textarea>
                    @error('description')
                        <div class="label pb-0"><span class="label-text-alt text-error">{{ $message }}</span></div>
                    @enderror
                </div>
                ...
                <div class="card-body gap-5">
                    ...
                    <div class="form-control">
                        ...
                        <div class="label pb-0">
                            <span class="label-text-alt text-base-content/50">{{ __('Team members will be able to see all monitors in this project.') }}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="flex gap-3 justify-end pt-2">
            <a href="{{ route('projects.index') }}" wire:navigate class="btn btn-ghost">{{ __('Cancel') }}</a>
